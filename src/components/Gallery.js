		...
		<div className="container mx-auto my-5 py-5 ">
			...
			<div className="container w-full mx-auto ">
				...
				<div className="md:masonry-2-col lg:masonry-3-col box-border mx-auto before:box-inherit after:box-inherit">
					<Card title="TouchDesigner VJ Rig" text="NAC23 party VJ rig built in TouchDesigner" imgsrc={[{src: 'thumbnails/nac23vj.png', alt: 'NAC23 VJ Rig'}]} link="/nac23vj" />
					<Card
						title="Live IMAG Effect, Notch"
						text="Demo of a live IMAG effect created in Notch. Uses Nvidia Broadcast background removal technology."
						imgsrc={[{src: 'thumbnails/NotchIMAG.jpg', alt: 'Live IMAG Effect'}]}
						link="/notchimag"
					/>
					<Card
					...
					<Card
						...
						link="/TOTO"
					/>
					<Card title="Manhole Cover in Rain" text="Playing around with substances in Notch." imgsrc={[{src: 'thumbnails/manhole.png', alt: 'manhole cover'}]} link="/manhole" />
