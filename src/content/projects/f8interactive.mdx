...
<div className="flex flex-wrap w-full mx-auto">
  <div className="my-1 w-full md:w-full lg:my-4 lg:w-1/2 lg:pr-5 xl:pr-10">
    <VimeoEmbed video={594474578} autoplay={true} loop={true} muted={true} controls={false} portrait={true} />
  </div>
  <div className="my-1 w-full md:w-full lg:my-4 lg:w-1/2 lg:pl-5 xl:pl-10">
    <VimeoEmbed video={594474463} autoplay={true} loop={true} muted={true} controls={false} portrait={true} />
  </div>
</div>
